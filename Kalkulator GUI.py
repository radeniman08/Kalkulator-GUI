...
window = Tk()
window.geometry("312x324") # ukuran lebar jendela:- 500, tinggi:- 375
window.resizable(0, 0) # ini mencegah dari mengubah ukuran jendela
window.title("Calcualtor")
################################### functions ######################################
# Fungsi 'btn_click' terus memperbarui bidang input setiap kali Anda memasukkan nomor
def btn_click(item):
...
#'StringVar()' digunakan untuk mendapatkan instance bidang input
 
input_text = StringVar()
 
# membuat bingkai untuk bidang input
